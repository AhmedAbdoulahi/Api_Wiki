...
public class Users {
    ...
    public Users(String email, String username, String password, String type, List<Question> mesquestions, List<Answer> mesreponses) {
        this.email = email;
    ...
    public Users(Long id, String email, String username, String password, String type, List<Question> mesquestions, List<Answer> mesreponses) {
        this.id = id;
        this.email = email;
        this.username = username;
        this.password = password;
    ...
    public Users(Long id, String email, String username, String password, String type) {
        this.id = id;
        this.email = email;
        this.username = username;
        this.password = password;
